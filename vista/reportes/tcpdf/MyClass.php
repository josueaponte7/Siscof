...
class MyClass extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $this->Image('imagenes/header.png', 12, 5, 185, 18, 'PNG', FALSE);
    }
...
class MyClassL extends TCPDF
{

    public function Header()
    {
        $this->setJPEGQuality(90);
        $this->Image('imagenes/header.png', 60, 5, 185, 18, 'PNG', FALSE);
    }
    ...
    public function Footer()
    {
        ...
        $this->Line(15, 285, 195, 285, $style);
        $this->Cell(35, 0, $fecha, 0, false, 'R', 0, '', 0, false, 'T', 'M');
        $this->Cell(250, 0, 'Página ' . $this->getAliasNumPage() . ' de ' . $this->getAliasNbPages(), 0, false, 'R', 0, '', 0, false, 'T', 'M');
    }
